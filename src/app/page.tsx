    ...
    <div className="font-serif text-gray-800 bg-gradient-to-br from-white via-[#fff9f0] to-[#fff3d6]">
      ...
      <header className="relative bg-[url('/hero-villa.jpg')] bg-cover bg-center h-[85vh]">
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2 }} className="relative z-10 h-full flex flex-col items-center justify-center text-white text-center px-6">
          ...
          <a href="#villas" className="bg-yellow-500 text-white hover:bg-yellow-600 font-bold py-2 px-6 rounded-full shadow-lg transition-transform transform hover:scale-105">Lihat Villa</a>
        </motion.div>
      </header>
      ...
      <section id="about" className="py-20 px-8 max-w-5xl mx-auto text-center">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }}>
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Villa Yoga Saputra menghadirkan pengalaman menginap eksklusif di lokasi terbaik Balikpapan.
            Dengan arsitektur modern dan fasilitas kelas dunia, villa ini menjadi destinasi sempurna
            untuk relaksasi, pesta pribadi, atau liburan romantis.
          </p>
        </motion.div>
      </section>
