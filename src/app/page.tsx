...
const villas = [
  {
    name: "Villa Mahameru",
    price: "Rp2.500.000/malam",
    image: "/villa1.jpg",
    facilities: ["3 Kamar Tidur", "Private Pool", "AC & Wi-Fi", "Dapur Lengkap"],
  },
  {
    name: "Villa Nirwana",
    price: "Rp3.000.000/malam",
    image: "/villa2.jpg",
    facilities: ["4 Kamar Tidur", "Jacuzzi", "Dekat Pantai", "Smart TV"],
  },
  {
    name: "Villa Arjuna",
    price: "Rp2.800.000/malam",
    image: "/villa3.jpg",
    facilities: ["3 Kamar Tidur", "Rooftop View", "Kolam Renang", "BBQ Area"],
  },
];
...
const testimonials = [
  {
    name: "Andi",
    comment: "Sungguh pengalaman menginap yang luar biasa!",
    rating: 5,
  },
  {
    name: "Sari",
    comment: "Villanya bersih dan sangat nyaman. Recomended!",
    rating: 4,
  },
  {
    name: "Budi",
    comment: "Pemandangan indah dan pelayanan terbaik.",
    rating: 5,
  },
];
...
const facilities = [
  ...
  { icon: "🧖‍♀️", title: "Spa & Sauna" },
  { icon: "🚗", title: "Parkir Luas" },
];
  ...
  return (
    <div className="font-serif text-gray-800 bg-gradient-to-br from-white via-[#fff9f0] to-[#fff3d6]">
      <nav className="flex justify-between items-center px-10 py-6 bg-white/80 backdrop-blur-md shadow-xl sticky top-0 z-50 rounded-b-xl border-b border-yellow-300">
        ...
        <ul className="flex gap-6 text-base font-semibold text-yellow-800">
          <li><a href="#about" className="hover:text-yellow-600">Tentang</a></li>
          <li><a href="#villas" className="hover:text-yellow-600">Villa</a></li>
          <li><a href="#facilities" className="hover:text-yellow-600">Fasilitas</a></li>
          <li><a href="#testimonials" className="hover:text-yellow-600">Testimoni</a></li>
          <li><a href="#contact" className="hover:text-yellow-600">Kontak</a></li>
        </ul>
      </nav>
      ...
      <header className="relative bg-[url('/hero-villa.jpg')] bg-cover bg-center h-[85vh]">
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2 }} className="relative z-10 h-full flex flex-col items-center justify-center text-white text-center px-6">
          ...
          <button onClick={scrollToVillas} className="bg-yellow-500 text-white hover:bg-yellow-600 font-bold py-2 px-6 rounded-full shadow-lg transition-transform transform hover:scale-105">Lihat Villa</button>
        </motion.div>
      </header>
      ...
      <section id="villas" className="py-20 bg-yellow-50 px-6">
        <h3 className="text-4xl font-semibold text-center mb-12 text-yellow-800">Pilihan Villa Eksklusif</h3>
